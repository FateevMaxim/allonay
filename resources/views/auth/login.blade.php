<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            <a href="https://api.whatsapp.com/send?phone={{$config->whats_app}}&text=Здравствуйте! Напомните, пожалуйста, мой пароль" class="w-9/12 mx-auto underline">
                Забыли пароль?
            </a>
        </div>
        <div class="flex items-center justify-end mt-4">
            ...
            <div class="flex items-center justify-end mt-4">
               <span class="w-9/12 mx-auto">Установите приложение на:</span>
            </div>
            @endif
