                            ...
                            <div id="defaultTabContent" class="p-4">
                                ...
                                <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <p><small>@if($track->city != '') Отправлено в город - {{ $track->city }} @elseif($track->status == 'Отправлено в Ваш город' && $track->city == '') Отправлено в Ваш город @else Готово к выдаче @endif</small><br />
