                            ...
                            <div class="overflow-hidden">
                                <form method="POST" action="{{ route('edit-accounting-in') }}">
                                    ...
                                    <div class="grid grid-cols-2 items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                                        ...
                                        <a href="/accounting"><button data-modal-hide="defaultModalRate" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">Отмена</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
