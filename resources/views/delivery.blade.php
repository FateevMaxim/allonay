                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full text-left text-sm font-light">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-4">Выдать</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($accountingOut as $ao)
                                        <tr
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4">
                                                    ...
                                                    @if($ao->status === 0)
                                                    <a href="{{ route('delivery-out', ['id' => $ao->id, 'type' => 'kaspi']) }}">
                                                        <button
                                                        type="button"
                                                        class="btn btn-error px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white btn-soft transition duration-150 ease-in-out">
                                                            Каспий
                                                        </button>
                                                    </a>
                                                    <a href="{{ route('delivery-out', ['id' => $ao->id, 'type' => 'cash']) }}">
                                                        <button
                                                            type="button"
                                                            class="btn btn-warning px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white btn-soft transition duration-150 ease-in-out">
                                                            Наличка
                                                        </button>
                                                    </a>
                                                    @else
